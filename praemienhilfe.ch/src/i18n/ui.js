...
export const ui = {
  de: {
    ...
    'hero.cantonTitle': (name) => `Prämienverbilligung ${name} — Anspruch prüfen und Antrag stellen`,
    'hero.cantonTitleDefault': 'Haben Sie Anspruch auf Prämienverbilligung?',
    'hero.cantonParagraph': 'Der Kanton gewährt Einwohnerinnen und Einwohnern in bescheidenen wirtschaftlichen Verhältnissen Beiträge zur Reduktion der Krankenkassenprämien. Wir helfen Ihnen, Ihren Anspruch zu prüfen und Ihren Antrag korrekt einzureichen.',
    'stickyCta.title': 'Anspruch prüfen',
    'stickyCta.titleWithCanton': (canton) => `Anspruch ${canton} prüfen`,
    ...
    'situationFinalCta.heading': 'Haben Sie Ihren Anspruch noch nicht geprüft?',
    'situationFinalCta.text': 'Starten Sie jetzt — es dauert weniger als 20 Minuten. Wählen Sie Ihre Situation:',
    'situationFinalCta.disclaimer': 'Kein offizielles Kantonsamt. Ein Service von EVO Partners GmbH, FINMA-registrierter Broker.',
    'funnel.householdQuestion': 'Wie viele Personen versichern Sie?',
    'funnel.household.onlyMe': 'Nur ich',
    'funnel.household.mePlusPartner': 'Ich + Partner/in',
    'funnel.household.familyWithChildren': 'Familie mit Kindern',
    'funnel.goodNews': '✓ Gute Nachricht — Sie könnten Anspruch haben!',
    'funnel.contactDetailsHeading': 'Ihre Kontaktangaben',
    'funnel.noObligation': 'Keine Verpflichtung. Diskret.',
    'funnel.submitError': 'Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut oder rufen Sie uns unter +41 76 779 0449 an.',
    'funnel.thankYouHeading': 'Vielen Dank!',
  ...
  en: {
    ...
    'hero.cantonTitle': (name) => `Health insurance premium subsidy in ${name} — check your eligibility and apply`,
    'hero.cantonTitleDefault': 'Are you entitled to a health insurance premium subsidy?',
    'hero.cantonParagraph': 'The canton grants contributions toward reducing health insurance premiums for residents with modest financial means. We help you check your eligibility and submit your application correctly.',
    'stickyCta.title': 'Check eligibility',
    'stickyCta.titleWithCanton': (canton) => `Check eligibility for ${canton}`,
    ...
    'situationFinalCta.heading': 'Haven’t checked your eligibility yet?',
    'situationFinalCta.text': 'Get started now — it takes less than 20 minutes. Choose your situation:',
    'situationFinalCta.disclaimer': 'Not an official cantonal office. A service of EVO Partners GmbH, a FINMA-registered broker.',
    'funnel.householdQuestion': 'How many people are you insuring?',
    'funnel.household.onlyMe': 'Just me',
    'funnel.household.mePlusPartner': 'Me + partner',
    'funnel.household.familyWithChildren': 'Family with children',
    'funnel.goodNews': '✓ Good news — you could be eligible!',
    'funnel.contactDetailsHeading': 'Your contact details',
    'funnel.noObligation': 'No obligation. Discreet.',
    'funnel.submitError': 'Something went wrong. Please try again or call us at +41 76 779 0449.',
    'funnel.thankYouHeading': 'Thank you!',
  ...
  es: {
    ...
    'hero.cantonTitle': (name) => `Reducción de primas del seguro médico en ${name} — compruebe su derecho y presente su solicitud`,
    'hero.cantonTitleDefault': '¿Tiene derecho a una reducción de primas del seguro médico?',
    'hero.cantonParagraph': 'El cantón concede aportaciones a los residentes con recursos económicos modestos para reducir sus primas del seguro médico. Le ayudamos a comprobar su derecho y a presentar su solicitud correctamente.',
    'stickyCta.title': 'Comprobar derecho',
    'stickyCta.titleWithCanton': (canton) => `Comprobar derecho ${canton}`,
    ...
    'situationFinalCta.heading': '¿Aún no ha comprobado su derecho?',
    'situationFinalCta.text': 'Empiece ahora — tarda menos de 20 minutos. Elija su situación:',
    'situationFinalCta.disclaimer': 'No es una oficina cantonal oficial. Un servicio de EVO Partners GmbH, corredor registrado ante FINMA.',
    'funnel.householdQuestion': '¿A cuántas personas está asegurando?',
    'funnel.household.onlyMe': 'Solo yo',
    'funnel.household.mePlusPartner': 'Yo + pareja',
    'funnel.household.familyWithChildren': 'Familia con hijos',
    'funnel.goodNews': '✓ Buenas noticias — podría tener derecho!',
    'funnel.contactDetailsHeading': 'Sus datos de contacto',
    'funnel.noObligation': 'Sin compromiso. Discreto.',
    'funnel.submitError': 'Algo salió mal. Por favor, inténtelo de nuevo o llámenos al +41 76 779 0449.',
    'funnel.thankYouHeading': '¡Gracias!',
